...
public class ConsumerA {
    ...
    public static void main(String[] args) {
        ...
        properties.put(PropertyKeyConst.ConsumerId, "CID-DEV-MXL-01");
        ...
        consumer.subscribe("TPC-DEV-TEST-MANYCONSUMER", "TagA", new MessageListener() {
            @Override
            public Action consume(Message message, ConsumeContext context) {
                System.out.println("ConsumerA Receive: " + new String(message.getBody()) + message.getMsgID());
